...
|---|---|---|
| `api/admin.ts` | ~2059 | **Partial:** radio/storage/addons/users/support/governance/news peeled to `api/admin/admin-*.ts`. Still: dashboard, selects, streams, announcements, financial, activity/logs, … |
