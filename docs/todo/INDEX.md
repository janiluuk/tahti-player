...
| partial | [viewshell-page-headers.md](viewshell-page-headers.md) | Cover-overlay Studio entity headers all done 2026-09-08; only StudioEpisodeReviewView's plain header left |
