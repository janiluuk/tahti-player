...
| open | [settings-footer-links-icon-row.md](settings-footer-links-icon-row.md) | (Later) Settings modal footer: GitHub/Discord/API docs links → one icon row, bigger icons |
