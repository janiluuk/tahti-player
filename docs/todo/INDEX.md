...
| partial | [codebase-refactor-hotspots.md](codebase-refactor-hotspots.md) | PluginStore categories done; admin users/support/gov/radio/storage/addons peeled; client.ts full named-module split done (~3000 → ~1419), off the P0 list; SettingsPanels / remaining admin domains still open |
