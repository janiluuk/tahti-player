...
| open | [governance-gap-list.md](governance-gap-list.md) | Governance features missing from tahti-player (16 gaps vs tahti-org; top-3 + 5 already shipped, see HISTORY) |
