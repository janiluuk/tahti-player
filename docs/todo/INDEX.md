...
| partial | [codebase-refactor-hotspots.md](codebase-refactor-hotspots.md) | PluginStore categories done; admin users/support/gov/radio/storage/addons peeled; client auth+requestJson+governance-member extracted; SettingsPanels / more client domains still open |
